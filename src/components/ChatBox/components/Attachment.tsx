      ...
      {attachments &&
        attachments.map((attachment, index) => {
          ...
          if (attachment.type === "image") {
            return (
              <div key={key}>
                <img className="rounded-xl my-2" src={attachment.mediaUrl} alt="" />
              </div>
            );
          }
            ...
            return (
              <div key={key}>
                <a href={attachment.mediaUrl} target="_blank" rel="noreferrer">
                  <video className="rounded-xl my-2" src={attachment.mediaUrl} />
                </a>
              </div>
            );
          }
          ...
          return (
            ...
            >
              ...
              <div>
                <div className="heading-text font-bold">{attachment.source?.name}</div>
                <div className="heading-text">{fileSizeUnit(attachment.source?.size)}</div>
              </div>
            </a>
          );
        })}
