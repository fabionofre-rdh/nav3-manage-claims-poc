...
const Input = (props: InputProps) => {
  ...
  // Extract onClick from rest to use on suffix
  const onClickHandler = rest.onClick;
    ...
    <span className={inputWrapperClass}>
      ...
      {suffix ? (
        <div
          ...
          style={{ cursor: onClickHandler && !disabled ? "pointer" : "default" }}
          onClick={!disabled ? (onClickHandler as MouseEventHandler<HTMLDivElement>) : undefined}
        >
          {suffix}
        </div>
      ) : null}
